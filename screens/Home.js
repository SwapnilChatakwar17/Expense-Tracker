...
import { COLORS, FONTS, SIZES, icons, images, AddCategory } from '../constants';
...
const Home = () => {
            ...
            <View style={{ paddingHorizontal: SIZES.padding, paddingVertical: SIZES.padding, backgroundColor: COLORS.white }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: SIZES.padding, alignItems: 'center' }}>
                    ...
                    <View style={{ marginLeft: SIZES.padding }}>
                        <Text style={{ color: COLORS.primary, ...FONTS.h3 }}>20 May, 2022</Text>
    ...
    function renderCategoryList() {
        ...
        //     render() {
        //         return(
        //             <View style={{ margin: 1, paddingHorizontal: SIZES.padding - 1, icon: icons.add}}>
        //                     <Button title="Add Category" color="orange" onPress={()=>{this.setState({show:true})}}></Button>
        //                     <Modal
        //                     transparent={true}
        ...
        return (
            <View>
                <View style={{ flexDirection: 'row', justifyContent: 'center' }}>
                    <View style={{ margin: 1, paddingHorizontal: SIZES.padding - 1, icon: icons.add}}>
                        <Button title="Add Category" color="orange" onPress={() => {
                    setSelectedCategory(categories)
                    setShowAddToBagModal(true)
                }}></Button>
                        
                    </View>
                    <View style={{ margin: 1, paddingHorizontal: SIZES.padding - 1, icon: icons.education_icon}}>
                        <Button title="Add Expense" onPress={() => console.log('Clicked')}></Button>
                    </View>
                </View>
                ...
                >
                    <View style={{ justifyContent: 'center', width: "85%", backgroundColor: selectedCategory.bgColor }}>
